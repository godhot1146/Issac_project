...
#arm_handle = gym.create_actor(env, franka_asset, gymapi.Transform(p=gymapi.Vec3(0.0, 0.0, 0.1)), "franka_asset", -1, 0)
franka_handle = gym.create_actor(env, vacuum_gripper_asset, gymapi.Transform(p=gymapi.Vec3(-1.0, 0.0, 0.5)), "vacuum_gripper_asset", -1, 0)
