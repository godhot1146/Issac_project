...
class StirfryRecordedGraspSequence(StirfryAutoSequence):
    ...
    # 접촉은 약 17 mm 안쪽, 13 mm 아래에서 형성됐다.
    ...
    def _finish_stage(self, stage):
        ...
        if stage.checkpoint == "recorded_contact_seek":
            ...
            self._rebase_after_recorded_contact()
